...
\begin{frame}{Setup - Data proxy}
	...
	ESP32)
	\begin{description}[Mean network \textbf{latency} evaluation]
...
\begin{frame}{Setup - Data analytics}
	...
	Forecast)
	\begin{description}[Num. of values \textbf{retreived}]
...
\begin{frame}{Evaluation}
	...
	\begin{description}[Data \textbf{analytics} started]
	...
	\begin{description}[Max difference \textbf{outdoor} forecasted-observed]
